    ...
    <AdminShell title="System Settings" subtitle="Supervision Geometry parameters and configurations">
      ...
      <AdminCard title="Engine Configurations" subtitle="Zoe Multi-tenant Boundaries & Sync Settings">
        <View className="bg-slate-800/50 rounded-xl border border-slate-700/50 overflow-hidden">
          ...
          <Pressable accessibilityRole="button" onPress={toggleWalMode} className="flex-row justify-between items-center p-4 border-b border-slate-700/50 active:bg-slate-700/30">
          ...
          <Pressable accessibilityRole="button" onPress={() => setNetworkOnline(!networkOnline)} className="flex-row justify-between items-center p-4 border-b border-slate-700/50 active:bg-slate-700/30">
            <View className="flex-1 pr-4">
          ...
          <Pressable accessibilityRole="button" onPress={() => setRemoteRejectActive(!remoteRejectActive)} className="flex-row justify-between items-center p-4 border-b border-slate-700/50 active:bg-slate-700/30">
            <View className="flex-1 pr-4">
          ...
          <Pressable accessibilityRole="button" onPress={toggleVerboseLogs} className="flex-row justify-between items-center p-4 border-b border-slate-700/50 active:bg-slate-700/30">
            <View className="flex-1 pr-4">
          ...
          <Pressable accessibilityRole="button" onPress={toggleSupervisionRestart} className="flex-row justify-between items-center p-4 active:bg-slate-700/30">
            <View className="flex-1 pr-4">
